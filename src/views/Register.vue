    ...
    <div class="modal-bg">
        <div class="login">
            <div class="login-normal">
                ...
                <button class="button" @click="emailRegister">Sign up</button>
            </div>
            <p class="is-title has-text-weight-bold" @click="closePopup">X</p>
            <button @click="socialLogin"><img src="../assets/google.png" alt="google logo" class="google"> <p class="is-size-5">Sign up with Google</p></button>
            <div class="already-a-user">
            <p class="is-size-5">Already registered?<router-link to="./login"> Login here</router-link></p>
            </div>
        </div>
  </div>
</template>
